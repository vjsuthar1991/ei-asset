                ...
                if (this.props.grid.showGridShowPerPage) {
                  return (
                      React.createElement("div", {className: "ngReactGridShowPerPage"}, 
                          "Show ", React.createElement("select", {onChange: this.handleChange,className: 'input-sm', ref: "showPerPage", value: this.props.grid.pageSize}, options), " entries"
                      )
                  )
                } else {
                  return (React.createElement("div", null))
                ...
                if (this.props.grid.showGridSearch) {
                  return (
                      React.createElement("div", {className: "ngReactGridSearch"}, 
                         "Search: " ,React.createElement("input", {type: "text", ref: "searchField", onKeyUp: this.handleSearch})
                      )
                  )
                } else {
                  return (React.createElement("div", null))
        ...
        var NgReactGridHeader = React.createClass({displayName: 'NgReactGridHeader',
            render: function() {
                ...
                var ngReactGridHeader = {
                    ...
                    height: hasColumnFilter(this.props.grid) ? "auto" : "40px"
                };
...
var NgReactGrid = function (scope, element, attrs, $rootScope) {
    ...
    this.pageSize = 10;
    this.pageSizes = [5,10,25, 50, 100, 500];
