...
class clspaging 
{
	...
	*/
	function writeHTMLpagesrange($url,$javascript=false,$URL_IMG="")
	{
		...
		echo "<td width=\"50%\"><b>Showing records ".$this->recsfrom."-".$this->recsto." (".$this->numofrecs." Total)</b></td>";
				echo "<td class='leftcoltext' valign='bottom' align=right>";
		...
		else
		{
			...
			if ($javascript) $turl="javascript:navigatepage('$varprefix',1);";
				echo "<b><span class='goldentext'><font size=2>";
		...
		for($i=$rangecurrentstart;$i<=$rangecurrentend;$i++)
		{
			...
			else
			{
				...
				if ($javascript) $turl="javascript:navigatepage('$varprefix',$i);";
					echo "&nbsp;<B><A href=\"$turl\"><font size=2>$i</font</B></A>";
			}
		}
		echo "</font></SPAN>";
		...
		else
		{
			...
			if ($javascript) $turl="javascript:navigatepage('$varprefix',$this->numofpages);";
				echo "&nbsp;<b><span class='goldentext'><font size=2><A href=\"$turl\">$this->numofpages</b></font></span></A>";
		}
		echo "</td>";
	...
	*/
	function writeHTMLpagesrange_SEO($url,$javascript=false,$URL_IMG="")
	{
		...
		echo "<span class='goldentext'><font size='2'>";
		for($i=$rangecurrentstart;$i<=$rangecurrentend;$i++)
		{
			if($this->currentpage==$i)
				echo "&nbsp;".$i;
		...
		else
		{
			...
			if ($javascript) $turl="javascript:navigatepage($this->numofpages);";
				echo "&nbsp;<b><span class='goldentext'><font size=2><A href=\"$turl\">Last</b></font></span></A>";
		}
		echo "</td></tr></table>";
	}
