...
class Lotgeneration extends CI_Controller {
	...
	*/    
    ...
    /*
		...
		Function Name: vendor_analysis_mis_list
	...
	*/
	...
	public function vendor_analysis_mis_list()
	{
		$inputRequest = json_decode(file_get_contents("php://input"),true);
		...
		$data['vendor_lotnos'] = $this->analysis_mis_list_model->getVendorAnalysisLotNos($round,$inputRequest['vendor_id']);
		
		$data['analysis_mis_reports'] = $this->analysis_mis_list_model->getAnalysisVendorReports($round,$inputRequest['vendor_id']);
